<?php 
    ...
    $prosql = "SELECT * FROM imqge where productid = 't-3' limit 1 ";
    $resultprosql = $conn->query($prosql);
    if(($resultprosql->num_rows > 0)){
        $product = $resultprosql->fetch_assoc();
    }
    $moresql = "SELECT * FROM moreinfo where productid = 't-3' limit 1 ";
...
<body>
    ...
    <main>
        <div class="product product-3">
            <div class="iner">
                <div class="full-img">
                    <img src="../img/p-3/<?php echo $moreproduct['img-1'] ?>.webp" class="main-img" id="img" width="330px" alt="">
                </div>
                <div class="iner-2">
                    <div class="">
                ...
                <!-- <img src="../img/p-3/img-2.webp" alt="" srcset=""> -->
            </div>
        </div>
        <div class="iner-3">
                <?php for($i=1;$i<5;$i++){?> 
                    <img src="../img/p-3/img-<?php echo $i?>.webp" class="inn img-<?php echo $i?>" id="<?php echo $moreproduct['productid'] ?>" width="200px" alt="">    
                <?php } ?>
        </div>
        <!-- <img src="" alt="" srcset=""> -->
    </main>
